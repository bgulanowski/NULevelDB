...
#define NULDBArrayToken(_array_, _count_) ([NSString stringWithFormat:@"%u:%@|NUArray", (unsigned)_count_, NSStringFromClass([[_array_ lastObject] class])])
#define NULDBIsArrayToken(_key_) ([_key_ hasSuffix:@"NUArray"])

#define NULDBArrayIndexKey(_key_, _index_) ([NSString stringWithFormat:@"%u:%@:NUIndex", (unsigned)_index_, _key_])
